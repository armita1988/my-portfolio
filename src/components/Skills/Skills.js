...
export default function Skills() {
  return (
    <div className={styles['skills']}>
      ...
      <div className={styles['skill-box']}>
        <div className={styles['skill-img-box']}>
          <img src="/assets/skills/express-js.png" alt="express icon" />
        </div>
        <p className={styles['skill-title']}>Express</p>
      </div>
      ...
      <div className={styles['skill-box']}>
        ...
        <p className={styles['skill-title']}>MySQL</p>
      </div>
      ...
      <div className={styles['skill-box']}>
        ...
        <p className={styles['skill-title']}>Python</p>
      </div>
    </div>
  );
}
